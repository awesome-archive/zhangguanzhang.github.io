var hljs = new (function() {
  ...
  function c(T, L, J, R) {
    ...
    function G(U, Y) {
      ...
      if (A(Y, I)) {
        throw new Error(
          'Illegal lexeme "' + Y + '" for mode "' + (I.cN || "<unnamed>") + '"'
        );
      }
      C += Y;
      return Y.length || 1;
...
hljs.registerLanguage("ruby", function(f) {
  ...
  var h = [
    ...
    k,
    {
      ...
      i: /=/,
      c: [
        f.inherit(f.TM, { b: "[A-Za-z_]\\w*(::\\w+)*(\\?|\\!)?" }),
        {
          cN: "inheritance",
          b: "<\\s*", 0="" c:="" [{="" cn:="" "parent",="" b:="" "("="" +="" f.ir="" "::)?"="" }]="" },="" k="" ]="" {="" "function",="" bk:="" "def",="" e:="" "="" |$|;",="" r:="" 0,="" [f.inherit(f.tm,="" j="" }),="" a,="" k]="" "constant",="" "(::)?(\\b[a-z]\\w*(::)?)+",="" "symbol",="" f.uir="" "(\\!|\\?)?:",="" ":",="" [e,="" }],="" "number",="" "(\\b0[0-7_]+)|(\\b0x[0-9a-fa-f_]+)|(\\b[1-9][0-9_]*(\\.[0-9_]+)?)|[0_]\\b",="" "variable",="" "(\\$\\w)|((\\$|\\@\\@?)(\\w+))"="" f.rsr="" ")\\s*",="" [="" c,="" k,="" "regexp",="" [f.be,="" d],="" i:="" \n="" ,="" v:="" ",="" [a-z]*"="" "%r{",="" "}[a-z]*"="" "%r\\(",="" "\\)[a-z]*"="" "%r!",="" "![a-z]*"="" "%r\\[",="" "\\][a-z]*"="" }="" ],="" ];="" d.c="h;" a.c="h;" var="" g="[" ^\s*="">/, cN: "status", starts: { e: "$", c: h } },
    { cN: "prompt", b: /^\S[^=>\n]*>+/, starts: { e: "$", c: h } }
  ];
  return {
  ...
  return {
    ...
    c: [
      ...
      a.CNM,
      {
        ...
        k: "return throw case",
        c: [a.CLCM, a.CBCM, a.RM, { b: /;/, r: 0, sL: "xml" }],
        r: 0
      },
      {
        cN: "function",
        ...
        c: [
          ...
          { cN: "params", b: /\(/, e: /\)/, c: [a.CLCM, a.CBCM], i: /["'\(]/ }
        ],
        i: /\[|%/
      },
      { b: /\$[(.]/ },
  ...
  return {
    ...
    c: [
      ...
      },
      {
        ...
        k: { title: "script" },
        c: [b],
        starts: { e: "", rE: true, sL: "javascript" }
      },
      { b: "<%", e:="" "%="">", sL: "vbscript" },
      d,
      { cN: "pi", b: /<\?\w+ ,="" e:="" \?="">/, r: 10 },
      {
        cN: "tag",
        b: "",
        c: [{ cN: "title", b: /[^ \/><\n\t]+ 0="" ,="" r:="" },="" b]="" }="" ]="" };="" });="" hljs.registerlanguage("markdown",="" function(a)="" {="" return="" aliases:="" ["md",="" "mkdown",="" "mkd"],="" c:="" [="" cn:="" "header",="" v:="" [{="" b:="" "^#{1,6}",="" e:="" "$"="" "^.+?\\n[="-]{2,}$"" }]="" "<",="" "="">", sL: "xml", r: 0 },
      { cN: "bullet", b: "^([*+-]|(\\d+\\.))\\s+" },
      { cN: "strong", b: "[*_]{2}.+?[*_]{2}" },
  ...
  return {
    ...
    c: [
      ...
      },
      {
        ...
        c: [
          { cN: "keyword", b: /\S+/ },
          { b: /\s/, eW: true, eE: true, r: 0, c: [c, a.ASM, a.QSM, a.CSSNM] }
        ]
      },
      { cN: "tag", b: b, r: 0 },
      {
...
hljs.registerLanguage("java", function(c) {
  ...
  return {
    aliases: ["jsp"],
    k: a,
    i: /<\ 0="" ,="" c:="" [="" {="" cn:="" "javadoc",="" b:="" "="" \\*\\*",="" e:="" "\\*="" ",="" r:="" 0,="" [{="" "javadoctag",="" "(^|\\s)@[a-za-z]+"="" }]="" },="" c.clcm,="" c.cbcm,="" c.asm,="" c.qsm,="" "class",="" bk:="" "class="" interface",="" [{;="]/," ee:="" true,="" k:="" i:="" [:"\[\]]="" "extends="" implements"="" c.utm]="" "new",="" \s="" "function",="" "("="" +="" b="" "\\s+)+"="" c.uir="" "\\s*\\(",="" rb:="" a,="" [c.utm]="" "params",="" \(="" \)="" [c.asm,="" c.cnm,="" c.cbcm]="" c.cbcm="" ]="" "annotation",="" "@[a-za-z]+"="" }="" };="" });="" hljs.registerlanguage("swift",="" function(a)="" var="" e="{" keyword:="" deinit="" enum="" extension="" func="" import="" init="" let="" protocol="" static="" struct="" subscript="" typealias="" break="" case="" continue="" default do="" else="" fallthrough="" if="" in="" for="" return="" switch="" where="" while="" as="" dynamictype="" is="" new="" super="" self="" type="" __column__="" __file__="" __function__="" __line__="" associativity="" didset="" get="" infix="" inout="" left="" mutating="" none="" nonmutating="" operator="" override="" postfix="" precedence="" prefix="" right="" set="" unowned="" safe="" unsafe="" weak="" willset",="" literal:="" "true="" false="" nil",="" built_in:="" "abs="" advance="" alignof="" alignofvalue="" assert="" bridgefromobjectivec="" bridgefromobjectivecunconditional="" bridgetoobjectivec="" bridgetoobjectivecunconditional="" c="" contains="" count="" countelements="" countleadingzeros="" debugprint="" debugprintln="" distance="" dropfirst="" droplast="" dump="" encodebitsaswords="" enumerate="" equal="" filter="" find="" getbridgedobjectivectype="" getvalist="" indices="" insertionsort="" isbridgedtoobjectivec="" isbridgedverbatimtoobjectivec="" isuniquelyreferenced="" join="" lexicographicalcompare="" map="" max="" maxelement="" min="" minelement="" nil="" numericcast="" partition="" posix="" print="" println="" quicksort="" reduce="" reflect="" reinterpretcast="" reverse="" rounduptoalignment="" sizeof="" sizeofvalue="" sort="" split="" startswith="" strideof="" strideofvalue="" swap="" swift="" tostring="" transcode="" true="" underestimatecount="" unsafereflect="" withextendedlifetime="" withobjectatpluszero="" withunsafepointer="" withunsafepointertoobject="" withunsafepointers="" withvalist"="" g="{" "type",="" "\\b[a-z][\\w']*",="" "comment",="" \\*",="" [a.pwm,="" "self"]="" "subst",="" \\\(="" "\\)",="" e,="" []="" f="{" "number",="" "\\b([\\d_]+(\\.[\\dee_]+)?|0x[a-fa-f0-9_]+(\\.[a-fa-f0-9p_]+)?|0b[01_]+|0o[0-7_]+)\\b",="" d="a.inherit(a.QSM," [c,="" a.be]="" c.c="[f];" d,="" a.clcm,="" b,="" g,="" f,="" "func",="" "{",="" a.inherit(a.tm,="" [a-za-z$_][0-9a-za-z$_]*="" }),="" "generics",="" \<="" \="">/, i: /\>/ },
          {
            cN: "params",
            b: /\(/,
            e: /\)/,
...
hljs.registerLanguage("php", function(b) {
  ...
  return {
    ...
    c: [
      ...
      { cN: "string", b: "<<<['\"]?\\w+['\"]?$", e:="" "^\\w+;",="" c:="" [b.be]="" },="" a,="" e,="" {="" cn:="" "function",="" bk:="" [;{]="" ,="" ee:="" true,="" i:="" "\\$|\\[|%",="" [="" b.utm,="" "params",="" b:="" "\\(",="" "\\)",="" ["self",="" b.cbcm,="" c,="" d]="" }="" ]="" "class",="" "class="" interface",="" "{",="" [:\(\$"]="" [{="" "extends="" implements"="" b.utm]="" "namespace",="" ";",="" [\.']="" [b.utm]="" "use",="" "="">" },
      c,
      d
    ]
  };
...
hljs.registerLanguage("cpp", function(a) {
  ...
  return {
    aliases: ["c", "h", "c++", "h++"],
    k: b,
    i: "</\></['\"]?\\w+['\"]?$",></\?(php)?|\?></\></"></\n\t]+></\?\w+></%",></script(?=\\s|></style(?=\\s|></\\!\\[cdata\\[",></\?(php)?(?!\w)></\\s*",></",>"]', k: "include", i: "\\n" }, a.CLCM]
      },
      {
        cN: "stl_container",
        b:
          "\\b(deque|list|queue|stack|vector|map|set|bitset|multiset|multimap|unordered_map|unordered_set|unordered_multiset|unordered_multimap|array)\\s*<", e:="" "="">",
        k: b,
        c: ["self"]
      },
      { b: a.IR + "::" }
